...
export default function NominatedSenseiPage() {
  ...
  const senseiOptions = useMemo(
    () => [
      ...
      { name: "Owi Sensei", img: "/owi.png", role: "Japanese Instructor", field: "Surabaya" },
      ...
      { name: "Gagah Sensei", img: "/gagah.png", role: "Japanese Instructor", field: "Tangerang" },
      { name: "Saidah Sensei", img: "/saidah.jpeg", role: "Japanese Instructor", field: "Advance Level" },
      { name: "Khansa Sensei", img: "/khansa.jpeg", role: "Japanese Instructor", field: "Advance Level" },
